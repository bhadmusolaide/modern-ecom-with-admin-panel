...
function LoginContent() {
  ...
  // No need to fetch CSRF token with Firebase Authentication
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      document.cookie = `auth-status=authenticated; path=/; max-age=${rememberMe ? 60 * 60 * 24 * 30 : 60 * 60 * 24}`;

      // Show success message
      setSuccess(`Login successful! Redirecting to ${redirectTo === '/admin' ? 'dashboard' : 'page'}...`);
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="input rounded-t-none rounded-b-md pr-10"
